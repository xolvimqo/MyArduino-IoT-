...
*************************************************/
String writeAPIKey = "332TJ75BWFT52NSO";
String readAPIKey = "Y14RBY0R5MTMJ2DP";
String channel = "827787";
/************************************************
         ENTER THING SPEAK CREDENTIALS
*************************************************/
...
void loop() {
  checkForUpdate();   //Main function is to check for an update to the fields on Thing Speak, further functionality stems from here.
  delay(2000);
}
